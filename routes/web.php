...
// Route::get('/', [PostController::class, 'index'])->name('posts.index'); // View all posts
...
Route::post('login', [LoginController::class, 'authenticate'])->name('login'); // Handle the login submission
